...
module.exports = {
  ...
  list: function (opts) {
    ...
    var availableTemplates = Object.keys(Helpers.scanTemplates(Constants.SETTINGS_DIR));

    if (displayInfo) Helpers.printHeader();

    // "do" commands
    if (display === 'long') {
      console.log(chalk.bold(' Available "do" commands:'));
      console.log();
      ...
      console.log(chalk.bold('Available "do" commands:  ') + availableCommands.join('  '));
    }
