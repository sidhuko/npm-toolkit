...
module.exports = {
  ...
  getScreenDefinition: function (screen) {
    ...
    var screenPath = config.resolved.ntrc + '/tasks.' + loadScreen + '.json';
    return require(screenPath);
  },

  scanTasks: function (dir) {
    if (debug) console.log('Scanning tasks in', dir);
    var tasks = {};
    if (dir) {
    ...
    if (debug) console.log('Finished scanning tasks');
    return tasks;
  },

  scanTemplates: function (dir) {
    if (debug) console.log('Scanning templates in', dir);
    var templates = {};
    if (dir) {
    ...
    if (debug) console.log('Finished scanning templates');
    return templates;
  }
