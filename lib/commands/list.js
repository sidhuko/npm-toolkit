...
module.exports = function (opts) {
  ...
  var availableTemplates = Object.keys(Helpers.scanTemplates(config.resolved.ntrc));
  ...
  if (display === 'detailed') {
    console.log('\n\n');
    console.log(chalk.bold(' Available "make" templates:'));
    console.log();
    ...
    console.log();
    console.log('You can create them by typing npm-toolkit make [template] [filename]');
  } else {
    console.log(chalk.bold('Available "make" templates:  ') + availableTemplates.join('  '));
  }
