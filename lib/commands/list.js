...
module.exports = function (opts) {
  ...
  if (display === 'detailed') {
    console.log('\n\n');
    console.log(chalk.bold(' Available file templates:'));
    console.log();
    ...
    console.log();
    console.log('You can create them by typing nt make [template] [filename]');
  } else {
    console.log(chalk.bold('Available file templates:  ') + availableTemplates.join('  '));
  }
